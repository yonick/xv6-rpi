...
enum {
    ...
    /* typed links  */
    Lterm = 1, Litd = 0 << 1, Lqh = 1 << 1, Lsitd = 2 << 1, Lfstn = 3 << 1, /* we don't use these */
    ...
    Citcshift = 16, Citcmask = 0xff << Citcshift,
    ...
    Prpidmask = 0xFF, Pspidshift = 8, /* sent pid */
    Pspidmask = 0xFF, Ptokshift  = 0, /* token pid */
    Ptokmask                     = 0xFF,
    ...
    Adevmask  = 0x7F, Aepshift = 0, /* endpoint number */
    Aepmask                    = 0xF,
};
